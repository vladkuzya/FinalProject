...
import ua.nure.kuzmin.SummaryTask4.db.entity.Category;
import ua.nure.kuzmin.SummaryTask4.db.entity.Edition;
import ua.nure.kuzmin.SummaryTask4.db.entity.Order;
import ua.nure.kuzmin.SummaryTask4.db.entity.User;
import ua.nure.kuzmin.SummaryTask4.exception.DBException;
import ua.nure.kuzmin.SummaryTask4.exception.Messages;
...
public final class DBManager {
    ...
    private static final String SQL_INSERT_USER = "INSERT INTO periodical.users(id, login, password, first_name, last_name, email, bill, roles_id, user_lock_id) VALUES(default, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private static final String CONNECTION_URL = "jdbc:mysql://localhost:3306/periodical?useUnicode=true&serverTimezone=UTC";
    ...
    public Connection getConnection() throws DBException {
        ...
        try {
    		...
    		con = DriverManager.getConnection(CONNECTION_URL,"root","12345");
